...
var colorOrdinal = d3.scaleOrdinal(d3.schemeCategory20b);
...
function createVisualization(json) {
  ...
  var path = vis.data([json]).selectAll("path")
      ...
      .style("fill", function (d) { return colorOrdinal((d.children ? d : d.parent).data.name); })
      .style("opacity", 1)
...
function buildWellbeingHierarchy(csv) {
